...
pip install pandas openpyxl pdfplumber defusedxml lxml reportlab
```
...
- `--mapping JSON` - JSON mapping file
- `--address-offset OFFSET` - Address offset (integer)
- `--forced-write VAL` - Forced write value
...
- Modbus addresses must be between 0 and 65535
