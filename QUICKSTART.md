...
- `--pages LIST` - PDF pages to process (e.g., "1,2,5")
- `--mapping FILE` - JSON file for custom column mapping
- `--address-offset NUM` - Integer to add to all addresses (default: 0)
- `--forced-write VAL` - Value for the Webdyn "Forced Write" header field
