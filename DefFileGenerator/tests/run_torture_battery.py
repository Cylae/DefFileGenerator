...
def run_torture_battery():
    ...
    rows = [
        {
            "Signal Name": "V_L1",
            "Register Offset": "0x7530",
            "Data Format": "float32 swap",
            "Measurement Unit": "V",
            "Ratio": "0.1",
        },
        {
            "Signal Name": "Status",
            "Register Offset": "30001",
            "Data Format": "BITS",
        ...
        {
            "Signal Name": "Freq",
            "Register Offset": "30,050",
            "Data Format": "unsigned int 32 big endian",
    ...
    with open("torture_test/output_str.csv") as f:
        content = f.read()
