...
class TestExtractor(unittest.TestCase):
    ...
    def test_normalize_action(self):
        ...
        self.assertEqual(self.extractor.normalize_action("4"), "4")
    ...
    def test_map_and_clean_excel(self):
        ...
        self.assertEqual(mapped[0]["Address"], "0x0001") # Extraction preserves original, normalization happens in def_gen
