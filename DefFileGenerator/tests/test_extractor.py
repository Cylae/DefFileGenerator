...
class TestExtractor(unittest.TestCase):
    ...
    def test_map_and_clean_excel(self):
        ...
        # In current implementation, map_and_clean DOES NOT normalize Type anymore,
        # it leaves it to Generator.process_rows or final normalization.
        # However, let's update test expectations based on current behavior.
