...
class TestExtractor(unittest.TestCase):
    ...
    def test_complex_address_mapping(self):
        raw_data = [
            {"Name": "BitVar", "Address": "200", "Type": "BITS", "StartBit": "5", "Length": "2"},
            {"Name": "StrVar", "Address": "100", "Type": "STRING", "Length": "10", "StartBit": ""}
        ]
        mapped = self.extractor.map_and_clean(raw_data)
        self.assertEqual(mapped[0]["Address"], "200_5_2")
        self.assertEqual(mapped[1]["Address"], "100_10")
