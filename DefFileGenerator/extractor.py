...
class Extractor:
    ...
    def map_and_clean(self, tables, address_offset=0):
        ...
        for table in tables:
            ...
            # Robust column detection: scan first few rows to find columns if first row is missing some
            all_src_cols = set()
            for row in table[:5]:
            ...
            for row in table:
                ...
                # Complex address construction: Addr_StartBit_Length or Addr_Length
