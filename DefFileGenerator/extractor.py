        ...
        def pdf_tables_generator():
            try:
                with pdfplumber.open(filepath) as pdf:
                    ...
                    page_indices = pages if isinstance(pages, list) else ([pages] if pages is not None else None)
                    ...
                    if page_indices is None:
                        ...
                        for p in page_indices:
                            if 1 <= p <= pdf_len:
                                ...
                                logging.warning(f"Page {p} out of range (1-{pdf_len}). Skipping.")
    ...
    def extract_from_xml(self, filepath: str) -> Iterator[Iterator[Dict[str, Any]]]:
        ...
        def xml_tables_generator():
            try:
                ...
                def xml_generator(root_node) -> Iterator[Dict[str, Any]]:
                    seen = set()
