...
class Extractor:
    ...
    def normalize_type(t: Any) -> str:
        if Generator and hasattr(Generator, 'normalize_type'):
        ...
        try:
            with pdfplumber.open(filepath) as pdf:
                ...
                if pages is None:
                    ...
                    elif isinstance(pages, str): requested = pages.split(',')
                ...
                for page in target_pages:
                    ...
                    for table in tables:
                        ...
                        def table_generator(current_table) -> Iterator[Dict[str, Any]]:
        ...
        def csv_table_generator() -> Iterator[Dict[str, Any]]:
            try:
                ...
                with open(filepath, 'r', encoding=encoding) as f:
                    ...
                    for row in reader:
                        if any(v.strip() for v in row.values() if v is not None and hasattr(v, 'strip')):
                            yield dict(row)
