        ...
        def excel_generator():
            ...
            try:
                ...
                for ws in sheets:
                    ...
                    # For Excel, we MUST consume the sheet generator while wb is open.
                    # To keep O(1) and nested structure, we yield it but be aware of wb lifecycle.
                    ...
                    if parsed_pages is None:
                        ...
                        for p_num in parsed_pages:
                            if 1 <= p_num <= num_pages:
                                ...
                                logging.warning(f"Page {p_num} is out of range (1-{num_pages}). Skipping.")
