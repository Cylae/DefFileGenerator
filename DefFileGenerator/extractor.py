...
class Extractor:
    COLUMN_MAPPING = {
        ...
        'Factor': ['scale', 'factor', 'multiplier', 'ratio', 'scalefactor'],
    ...
    def normalize_type(self, t):
        if not t:
            return 'U16'
        # Delegate to generator's normalize_type for consistency
    ...
    def map_and_clean(self, tables, address_offset=0):
        ...
        for table in tables:
            ...
            for row in table:
                ...
                if addr:
                    # Normalize parts first
                    parts = [self.generator.normalize_address_val(p) for p in addr.split('_')]
