...
class Extractor:
    ...
    def normalize_type(self, t):
        """Delegates type normalization to the Generator."""
    ...
    def map_and_clean(self, tables, address_offset=0):
        ...
        # Ensure tables is a list of tables
        ...
        for table in tables:
            ...
            for row in table:
                ...
                if not addr and target == 'Address': # Fallback if we have Offset but not Address? No, already mapped.
                    pass

                # Handle complex addresses (Address + Length + StartBit)
                ...
                if addr:
                    ...
                    if length and '_' not in norm_addr:
                        norm_addr = f"{norm_addr}_{length}"
                        if start_bit:
                            norm_addr = f"{norm_addr}_{start_bit}"
