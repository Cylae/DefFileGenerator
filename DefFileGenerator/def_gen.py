...
class Generator:
    ...
    def apply_address_offset(self, address, offset, line_num=None):
        ...
        if not address or offset == 0:
            # Still normalize parts to decimal if possible
        ...
        try:
            ...
            if base_addr < 0:
                ...
                logging.warning(f"{loc}Address offset {offset} results in negative address {base_addr} for '{address}'.")
