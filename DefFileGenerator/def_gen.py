...
class Generator:
    ...
    @staticmethod
    def _calculate_coefficients(factor, offset, scale_factor_str):
        try:
    ...
    def process_rows(self, rows, address_offset=0):
        ...
        for line_num, row in enumerate(rows, start=2):
            ...
            dtype, address = self._normalize_type_and_address(dtype_raw, address, name, address_offset, line_num)
            if dtype is None:
                continue
