...
class Generator:
    ...
    def _parse_numeric(self, val, default=0.0):
        """Robustly parses numeric strings, handling fractions and locale formats."""
        ...
        # Handle locale-specific thousands separators and decimals
        ...
        try:
            if ',' in s and '.' in s:
                ...
                # Single comma. Use heuristic: if it looks like thousands (e.g. 1,234)
                # and NOT like a decimal (0,001)
    ...
    def _process_name_and_tag(self, name, tag, line_num, seen_names, seen_tags):
        """Validates name and tag, auto-generating tag if needed."""
        if name:
