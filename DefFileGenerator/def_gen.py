...
class Generator:
    ...
    def apply_address_offset(self, address, offset):
        """Applies offset and normalizes to decimal."""
    ...
    def _process_name_and_tag(self, row, line_num, seen_tags, seen_names):
    ...
    def process_rows(self, rows, address_offset=0):
        ...
        for line_num, row in enumerate(rows, start=2):
            ...
            name, tag = self._process_name_and_tag(row, line_num, seen_tags, seen_names)
