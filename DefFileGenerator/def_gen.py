...
class Generator:
    ...
    def process_rows(self, rows: Iterable[Dict[str, Any]], address_offset: int = 0) -> Iterator[Dict[str, Any]]:
        ...
        for line_num, row in enumerate(rows, start=2):
            ...
            if not act_str:
                # Intelligent defaulting based on Info1 (Modbus Register Type)
                if info1 in ['2', '4']: # Discrete Inputs or Input Registers
                    norm_action = '4' # Read Only
                else: # Holding Registers or Coils
    ...
    def write_output_csv(output: Union[str, Any, None], processed_rows: Iterable[Dict[str, Any]], manufacturer: str, model: str,
        ...
        try:
            ...
            logging.info(f"Summary: Coils: {counts['1']}, Discrete Inputs: {counts['2']}, "
                         f"Holding Registers: {counts['3']}, Input Registers: {counts['4']}")
