...
def main():
    ...
    parser_generate.add_argument('--address-offset', type=int, default=0, help='Value to subtract from all register addresses.')
    ...
    parser_run.add_argument('--address-offset', type=int, default=0, help='Value to subtract from all register addresses.')
