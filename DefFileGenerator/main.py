...
TOP_LEVEL_ERRORS = (OSError, ValueError, TypeError, KeyError, csv.Error)
...
def _run_cli():
    ...
    if args.command == 'extract':
        ...
        # Positional args with nargs='?' aren't required, so we manually check
