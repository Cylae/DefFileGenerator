...
def _perform_extraction(args):
    ...
    pages_arg = args.pages if hasattr(args, 'pages') else None
    offset = int(args.address_offset) if hasattr(args, 'address_offset') and args.address_offset else 0
...
def generate_command(args):
    config = GeneratorConfig(
        ...
        address_offset=int(args.address_offset) if args.address_offset else 0,
...
def main():
    ...
    parser_extract.add_argument('--address-offset', default=0, help='Address offset')
    ...
    parser_generate.add_argument('--address-offset', default=0, help='Address offset')
    ...
    parser_run.add_argument('--address-offset', default=0, help='Address offset')
