...
def main():
    ...
    parser_generate.add_argument('--address-offset', dest='address_offset', type=int, default=0)
    ...
    parser_run.add_argument('--address-offset', dest='address_offset', type=int, default=0)
