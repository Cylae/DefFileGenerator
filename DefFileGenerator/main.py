...
def _run_cli():
    ...
    parser_generate.add_argument('--manufacturer', required=False) # Manual validation if not template
    parser_generate.add_argument('--model', required=False)        # Manual validation if not template
