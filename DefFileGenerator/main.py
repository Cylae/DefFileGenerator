        ...
        if ext in ['.xlsx', '.xlsm', '.xltx', '.xltm']:
            ...
            if args.pages:
                try:
                    ...
                    logging.error(f"Invalid page range: {args.pages}")
...
def main():
    ...
    parser_extract.add_argument('--address-offset', type=int, default=0, help='Address offset to apply during extraction')
    ...
    parser_generate.add_argument('--template', action='store_true', help='Generate a sample input file')
