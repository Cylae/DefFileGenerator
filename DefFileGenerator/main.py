...
def run_command(args):
    ...
    try:
        # Note: address_offset was already applied during extraction.
        # To avoid double-offsetting, we pass 0 to the generator.
        config = GeneratorConfig(
            input_file=temp_csv,
            output=args.output,
            manufacturer=args.manufacturer,
...
def main():
    ...
    parser_run.add_argument('--manufacturer', required=True, help='Manufacturer name')
