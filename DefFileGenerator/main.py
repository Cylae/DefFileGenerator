...
def main():
    ...
    # Extract
    parser_extract = subparsers.add_parser('extract', help='Extract registers from PDF/Excel/CSV')
    parser_extract.add_argument('input_file', help='Source file (PDF/Excel/CSV)')
    ...
    parser_run.add_argument('input_file', help='Source file (PDF/Excel/CSV)')
