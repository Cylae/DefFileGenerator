...
def _perform_extraction(args):
    ...
    has_raw, raw_data = peek_generator(raw_data)
    if not has_raw:
...
def _run_cli():
    ...
    # Validate
    parser_validate = subparsers.add_parser('validate', help='Validate a Webdyn definition CSV')
    ...
    # Manual validation for generate/run
