...
def extract_command(args):
    ...
    # Apply offset for standalone extraction if specified
...
def run_command(args):
    # Pass address_offset to extraction for 'run' command
    # and then 0 to generation to avoid double-offsetting.
    mapped_data = _perform_extraction(args)
    if not mapped_data:
        return
