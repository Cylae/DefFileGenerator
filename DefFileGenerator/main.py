...
def main():
    ...
    parser_generate.add_argument('--address-offset', type=int, default=0, help='Shift register addresses')
    ...
    parser_run.add_argument('--address-offset', type=int, default=0, help='Shift register addresses')
