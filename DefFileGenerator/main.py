...
def main():
    ...
    parser_extract.add_argument('--address-offset', type=int, default=0, help='Value to subtract from all addresses')
    ...
    parser_generate.add_argument('--address-offset', type=int, default=0, help='Value to subtract from all addresses')
    ...
    parser_run.add_argument('--address-offset', type=int, default=0, help='Value to subtract from all addresses')
