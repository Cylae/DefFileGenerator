...
def run_command(args):
    ...
    # In 'run' mode, _perform_extraction already applied the address_offset.
    # To prevent double-offsetting in run_generator, we pass 0 as the offset.
...
def main():
    ...
    # Add template flag to generate subcommand for feature parity
