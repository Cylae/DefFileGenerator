...
def run_command(args):
    # To prevent double-offsetting, we apply it during extraction (already in mapped_data)
...
def main():
    ...
    if args.command == 'extract':
        ...
        if not args.template and (not args.manufacturer or not args.model):
            parser_generate.error("the following arguments are required: --manufacturer, --model")
