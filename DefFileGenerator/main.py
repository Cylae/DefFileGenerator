...
def _perform_extraction(args):
    ...
    return list(extractor.map_and_clean(raw_data_peeked, address_offset))
...
def _run_cli():
    ...
    parser_generate.add_argument('--template', action='store_true', help='Generate a template definition')
    ...
    # Validate
    parser_validate = subparsers.add_parser('validate', help='Validate existing Webdyn definition CSV')
