...
def main():
    ...
    parser.add_argument('--template', action='store_true', help='Generate definition CSV template')
    ...
    if args.template:
        output_file = args.output or "template_definition.csv"
    ...
    # Apply offset during extraction, then pass 0 to generator to prevent double-offsetting
