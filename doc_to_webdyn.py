...
def main():
    ...
    parser.add_argument('--template', action='store_true', help='Generate a sample definition file')
    ...
    if args.template:
        output_file = args.output or "template_registers.csv"
    ...
    generator = Generator()
    # Address offset already applied by extractor.map_and_clean
