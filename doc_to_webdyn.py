...
def _run_cli():
    ...
    parser.add_argument('--validate', action='store_true', help='Validate an existing definition file')
    ...
    is_empty, mapped = peek_generator(mapped)
    if is_empty: logging.error("No registers extracted."); sys.exit(1)
