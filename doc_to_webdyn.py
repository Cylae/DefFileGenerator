...
def main():
    ...
    parser.add_argument('--template', action='store_true', help='Generate template file')
    ...
    generator = Generator()
    processed = generator.process_rows(mapped, address_offset=0) # Offset already applied during extraction
