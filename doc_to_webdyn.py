...
def main():
    ...
    parser.add_argument('--address-offset', type=int, default=0, help='Shift register addresses')
    parser.add_argument('--forced-write', default='', help='Registers to force to Write action')
