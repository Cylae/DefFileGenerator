...
def main():
    ...
    generator = Generator()
    # To prevent double-offset, pass the user offset to process_rows if doc_to_webdyn.py
    # handles extraction and generation in one go without intermediate CSV.
    # The Extractor.map_and_clean already normalized the base address but didn't apply offset.
