...
def main():
    ...
    parser.add_argument('--forced-write', default='', help='Forced write string')
    ...
    generator = Generator()
    # Pass 0 to Generator to avoid double-offsetting
    ...
    generator.write_output_csv(output_file, processed, args.manufacturer, args.model, args.protocol, args.category, forced_write=args.forced_write)
