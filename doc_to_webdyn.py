...
def main():
    ...
    generator = Generator()
    # Apply offset here or in process_rows.
    # To match main.py 'run' command logic:
    # run_command in main.py applies offset during extraction (via Extractor) or in Generator.
    # Actually main.py run_command doesn't seem to have address_offset in its parser for 'run'!
