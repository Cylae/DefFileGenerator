...
def main():
    ...
    parser.add_argument('input_file', help='Path to documentation file (PDF, Excel, CSV, XML)')
    ...
    # Configure logging with force=True to override imports
    ...
    if not mapped_data:
        logging.error("No registers extracted after cleaning.")
        sys.exit(1)
    ...
    # Write mapped data to a temporary CSV to use the run_generator logic
