...
def normalize_address(addr, generator):
    if is_na(addr):
        return ''
    ...
    return generator.normalize_address_val(addr_str)
...
def main():
    ...
    for df in dataframes:
        ...
        for _, row in df.iterrows():
            ...
            addr = normalize_address(addr_raw, generator)
            ...
            # Clean scale (sometimes it's "1/10" or "0.1") - now handled by Generator but kept for extracted_row
            scale = str(scale_raw)
