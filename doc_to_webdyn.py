...
def _run_cli():
    ...
    # Use peek_generator to check if any data was extracted without consuming
    first_table, raw = peek_generator(raw)
    ...
    # Use peek_generator to check if any registers were mapped without consuming
