...
def main():
    ...
    parser.add_argument('--forced-write', default='', help='Value for forced_write field')
    parser.add_argument('--template', action='store_true', help='Generate a sample input template')
    ...
    if args.template:
        ...
        output = args.output or "template_registers.csv"
