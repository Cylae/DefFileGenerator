...
def _run_cli():
    ...
    mapped_data = extractor.map_and_clean(raw_peeked, args.address_offset)
    has_regs, mapped_data_peeked = peek_generator(mapped_data)
    ...
    run_generator(config, input_data=mapped_data_peeked)
