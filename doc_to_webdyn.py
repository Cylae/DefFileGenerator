...
def main():
    ...
    parser.add_argument('--template', action='store_true', help='Generate a mapping template')
    ...
    if args.template:
        output_file = args.output or "template_mapping.csv"
    ...
    generator = Generator()
    # pass 0 as offset since it was already applied in map_and_clean
