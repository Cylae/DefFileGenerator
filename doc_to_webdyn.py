...
def _run_cli():
    ...
    if not args.input_file:
        logging.error("Input file is required unless --template is used.")
        sys.exit(1)
    ...
    mapped_data = extractor.map_and_clean(raw_iter, args.address_offset)
    has_mapped, mapped_iter = peek_generator(mapped_data)
