...
def main():
    ...
    parser.add_argument('--forced-write', default='', help='Forced write value for header')
    ...
    # Apply address offset during extraction mapping
    ...
    generator = Generator()
    # Pass 0 offset to generator because it's already applied in extractor
