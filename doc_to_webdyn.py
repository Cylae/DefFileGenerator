...
def main():
    ...
    parser.add_argument('--template', action='store_true', help='Generate a sample definition template')
    ...
    # To prevent double-offsetting, we pass the offset to map_and_clean
    # and 0 to process_rows.
