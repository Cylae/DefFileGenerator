...
def main():
    ...
    if ext in ['.xlsx', '.xlsm', '.xltx', '.xltm']:
        ...
        try:
            ...
            logging.error(f"Invalid --pages: {args.pages}. Use comma-separated integers.")
            sys.exit(1)
    ...
    # Apply address offset during extraction to match DefFileGenerator/main.py behavior
