...
def main():
    ...
    # To prevent double-offset application, we apply the offset during extraction (via map_and_clean)
    # and pass a fixed 0 offset to the Generator's process_rows method.
