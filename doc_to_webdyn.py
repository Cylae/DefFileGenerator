...
def main():
    ...
    elif ext == '.pdf': raw = extractor.extract_from_pdf(args.input_file, pages=pages)
    ...
    # Pass address_offset to map_and_clean
    ...
    generator = Generator()
    # Pass address_offset=0 to process_rows to avoid double-offsetting
