...
def main():
    ...
    if ext == '.csv':
        ...
        pages = None
        # Add support for pages argument if it existed or just extract all
    ...
    logging.info(f"Extracted {len(raw_data)} table(s) from the file.")

    # Use Extractor's map_and_clean which now handles list of tables
