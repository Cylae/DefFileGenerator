...
def _run_cli():
    ...
    if not args.input_file:
        parser.error("the following arguments are required: input_file (or use --template)")
    ...
    has_regs, mapped_it = peek_generator(extractor.map_and_clean(raw_it, args.address_offset))
