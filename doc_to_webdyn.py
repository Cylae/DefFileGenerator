...
def _run_cli():
    ...
    if not args.input_file or not args.manufacturer or not args.model:
        logging.error("input_file, --manufacturer, and --model are required unless using --template.")
        sys.exit(1)
