...
def main():
    ...
    if not args.input_file or not args.manufacturer or not args.model:
        parser.error("the following arguments are required: input_file, --manufacturer, --model (unless --template is used)")
    ...
    # Pass address_offset to extractor
    ...
    generator = Generator()
    # Pass 0 to generator to prevent double-offsetting
