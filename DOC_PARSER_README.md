...
- `--mapping`: Path to a JSON mapping file for custom column detection.
- `--address-offset`: Integer offset to add to all register addresses.
- `--forced-write`: Optional value for the forced write header field.
